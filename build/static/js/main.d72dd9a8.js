...
/******/ 		}
/******/ 		script.src = __webpack_require__.p + "static/js/" + ({}[chunkId]||chunkId) + "." + {"0":"f17df453"}[chunkId] + ".chunk.js";
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_4__reportWebVitals__ = __webpack_require__(70);
...
*/
var aa=__webpack_require__(7),ca=__webpack_require__(32);function p(a){for(var b="https://reactjs.org/docs/error-decoder.html?invariant="+a,c=1;c<arguments.length;c++)b+="&args[]="+encodeURIComponent(arguments[c]);return"Minified React error #"+a+"; visit "+b+" for the full message or use the non-minified dev environment for full errors and additional helpful warnings."}var da=new Set,ea={};function fa(a,b){ha(a,b);ha(a+"Capture",b)}
...
"use strict";
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__App_css__ = __webpack_require__(39);
...
var _slicedToArray=function(){function sliceIterator(arr,i){var _arr=[];var _n=true;var _d=false;var _e=undefined;try{for(var _i=arr[Symbol.iterator](),_s;!(_n=(_s=_i.next()).done);_n=true){_arr.push(_s.value);if(i&&_arr.length===i)break;}}catch(err){_d=true;_e=err;}finally{try{if(!_n&&_i["return"])_i["return"]();}finally{if(_d)throw _e;}}return _arr;}return function(arr,i){if(Array.isArray(arr)){return arr;}else if(Symbol.iterator in Object(arr)){return sliceIterator(arr,i);}else{throw new TypeError("Invalid attempt to destructure non-iterable instance");}};}();// // import logo from './logo.svg';
// import './App.css';
...
//     <p className="item-description">{item.item_details}</p>
//   </li>
//       ))}
//  </ul>
//     </div>
...
// }
// export default App;
function App(){var _useState=Object(__WEBPACK_IMPORTED_MODULE_2_react__["useState"])([]),_useState2=_slicedToArray(_useState,2),itemList=_useState2[0],setItemList=_useState2[1];Object(__WEBPACK_IMPORTED_MODULE_2_react__["useEffect"])(function(){getItems();},[]);var getItems=function getItems(){__WEBPACK_IMPORTED_MODULE_1_axios__["a" /* default */].get("https://fakestoreapi.com/products").then(function(response){setItemList(response.data);}).catch(function(error){console.error('Error fetching items:',error);});};return __WEBPACK_IMPORTED_MODULE_2_react___default.a.createElement('div',{className:'App'},__WEBPACK_IMPORTED_MODULE_2_react___default.a.createElement('ul',{className:'list-view'},itemList.map(function(item){return __WEBPACK_IMPORTED_MODULE_2_react___default.a.createElement('li',{className:'list-item',key:item.id},__WEBPACK_IMPORTED_MODULE_2_react___default.a.createElement('h3',{className:'item-title'},item.title),__WEBPACK_IMPORTED_MODULE_2_react___default.a.createElement('p',{className:'item-description'},item.description));})));}/* harmony default export */ __webpack_exports__["a"] = (App);
...
"use strict";
var reportWebVitals=function reportWebVitals(onPerfEntry){if(onPerfEntry&&onPerfEntry instanceof Function){__webpack_require__.e/* import() */(0).then(__webpack_require__.bind(null, 71)).then(function(_ref){var getCLS=_ref.getCLS,getFID=_ref.getFID,getFCP=_ref.getFCP,getLCP=_ref.getLCP,getTTFB=_ref.getTTFB;getCLS(onPerfEntry);getFID(onPerfEntry);getFCP(onPerfEntry);getLCP(onPerfEntry);getTTFB(onPerfEntry);});}};/* harmony default export */ __webpack_exports__["a"] = (reportWebVitals);

/***/ })
/******/ ]);
//# sourceMappingURL=main.d72dd9a8.js.map